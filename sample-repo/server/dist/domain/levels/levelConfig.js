...
exports.LEVEL_CONFIGS = void 0;
exports.getLevelConfig = getLevelConfig;
const shared_1 = require("@vibecode/shared");
const { Red, Orange, Yellow, Green, Blue, Purple } = shared_1.CandyType;
/**
...
function getLevelConfig(levelNumber) {
    if (levelNumber < 1 || levelNumber > 20) {
        throw new RangeError(`Level number must be between 1 and 20, got ${levelNumber}`);
    }
    return exports.LEVEL_CONFIGS[levelNumber - 1];
}
